...
<div class="flex justify-center self-center  z-10">
	<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
		<div class="mb-7">
			<h3 class="font-semibold text-2xl text-center text-gray-800">Sign In </h3>
			<p class="text-gray-400 text-center">Don't have an account?
                <a href="{{ route('register') }}" class="text-sm text-purple-700 hover:text-purple-700">Sign Up</a>
            </p>
		</div>
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="space-y-6">
                <div class="">
                    <input class="w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" name="email" type="email" value="{{ old('email') }}" id="email" placeholder="Email">
                    @error('email')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
              </div>
                    <div class="relative" x-data="{ show: true }">
                        <input id="password" name="password" placeholder="Password" :type="show ? 'password' : 'text'" class="text-sm text-black px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
                        @error('password')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
		 ...
		 <span>Google</span>
		   ...
		   <span>Facebook</span>
			...
			<div class="mt-7 text-center text-black text-xs">
				<span>
			Copyright © 2021-2023
			<a href="/" rel="" target="_blank" title="Codepen aji" class="text-purple-500 hover:text-purple-600 ">Around You</a></span>
			</div>
		</div>
	</div>
</div>

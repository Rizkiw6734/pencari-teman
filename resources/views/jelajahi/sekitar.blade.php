            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3 mt-0" id="friendList">
                @if($penggunaLain->isEmpty())
                    <div class="flex-grow-1"
                        style="overflow-y: auto; min-height: 400px; max-height: 600px;">
                        <div id="welcome-message" class="text-center">
                            <img src="{{ asset('images/no-users.svg') }}" alt="Tidak ada pengguna" class="mt-5"
                                style="max-width: 50%; height: auto;">
                            <p class="mt-2 text-dark">Tidak ada pengguna di sekitar.</p>
                        </div>
                    </div>
                @else

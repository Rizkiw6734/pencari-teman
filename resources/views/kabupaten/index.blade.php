            ...
            <div class="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                  ...
                  <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kabupaten</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Kabupaten</h6>
              </nav>
                                ...
                                <tbody>
                                    @foreach ($kabupaten as $data)
                                        <tr>
                                            ...
                                            <td>{{ optional($data->provinsi)->nama ?? 'Provinsi tidak ditemukan' }}</td>
                                            <td>{{ $data->nama }}</td>
                                            <td>
                                                <!-- Tombol Edit -->

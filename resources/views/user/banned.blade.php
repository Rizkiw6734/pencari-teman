...
<body>
    <div class="image-container"
        style="text-align: center; display: flex; flex-direction: column; justify-content: center; align-items: center; min-height: 100vh; font-family: 'Poppins', sans-serif;">
        <img src="/assets/img/banned.svg" alt="Descriptive Text" style="max-width: 30%; height: auto;">
        <p style="margin-top: 30px; color: #000000; font-size: 18px;">Halo <b>{{ Auth::user()->name }}</b>,</p>
        <p style="margin-top:-15px; font-size: 18px; color: #000000;">Akun Anda telah <em><b>diblokir secara
                    permanen</b></em> karena pelanggaran kebijakan.</p>
        <p style="margin-top:-15px; font-size: 18px; color: #000000;">Untuk informasi lebih lanjut atau pengajuan
            banding, silakan hubungi tim</p>
        <p style="margin-top:-15px; font-size: 18px; color: #000000;">dukungan kami.</p>
    </div>

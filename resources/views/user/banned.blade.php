...
<body>
    <div class="image-container"
        ...
        <img src="/assets/img/banned.svg" alt="Descriptive Text" style="max-width: 35%; height: auto;">
        <p style="margin-top: 40px; color: #000000; font-size: 22px;">Halo <b>Alifio Galang</b>,</p>
        <p style="margin-top:-18px; font-size: 22px; color: #000000;">Akun Anda telah <em><b>diblokir secara
                    permanen</b></em> karena pelanggaran kebijakan.</p>
        <p style="margin-top:-18px; font-size: 22px; color: #000000;">Untuk informasi lebih lanjut atau pengajuan
            banding, silakan hubungi tim</p>
        <p style="margin-top:-18px; font-size: 22px; color: #000000;">dukungan kami.</p>

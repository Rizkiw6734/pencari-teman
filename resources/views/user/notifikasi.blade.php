    ...
    <div class="main-content"
        ...
        <div class="container-fluid">
            ...
            <div id="chat-container" style="height: 500px; overflow-y: scroll;">
                ...
                <div class="notifikasi" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $notification->id }}">
                    <div class="d-flex align-items-center p-2 rounded shadow-sm w-100 px-3 mb-3"
                        ...
                        <div class="flex-grow-1">
                            <p class="mb-0" style="color: #000000; font-size: 14px;">{{ $notification->judul }}</p>
                ...
                <!-- Modal -->
                <div class="modal fade" id="exampleModal{{ $notification->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
...
@endif
            ...
            <div id="all-activities" style="display: none;">
                ...
                <!-- Tambahkan notifikasi bulan ini di sini -->
            </div>

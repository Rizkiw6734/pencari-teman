        ...
        <div class="modal-body">
            <div class="card" style="box-shadow: 0px 0px 1px 1px rgba(82, 139, 255, 0.25);">
                <div class="card-body" >
                    <form id="ratingform" action="#" method="POST" enctype="multipart/form-data">
                        <div class="mb-3 d-flex flex-column">
                            ...
                            <!-- Input Ulasan -->
                            <label for="ulasan" class="form-label fw-bold text-start" style="font-size: 17px; margin-bottom: -15px;">Ulasan</label>
                ...
                <div class="modal-footer d-flex justify-content-between border-0 mx-2" style="margin-bottom: -5px; margin-top: -20px;">
                    <button type="button" class="btn" style="font-size: 14px; padding: 10px 30px; background-color: #528BFF; color: white;">Kirim</button>

                ...
                <div class="col-sm-12 col-md-5 mt-0">
                    <div class="card shadow-sm h-100">
                        <div class="card-body text-center"
                            style="box-shadow: 0px 0px 5px 1px rgba(82, 139, 255, 0.25); border-radius: 12px;">
                            ...
                            <script>
                                function goBackAndRefresh() {
                                    ...
                                    window.location.href = prevPage ? prevPage :
                                    '/'; // Kembali ke halaman sebelumnya atau ke halaman utama jika tidak ada
                                    setTimeout(() => {
                            ...
                            <div class="position-absolute top-0 end-0 m-3">
                                ...
                                @else
                                    ...
                                    <i class="fa-solid fa-user-plus text-danger p-2 rounded-circle" style="font-size: 20px;"
                                ...
                                <div class="d-grid gap-5 d-md-flex justify-content-center mt-2">
                                    ...
                                    @if (auth()->user()->blokiran()->where('blocked_user_id', $user->id)->exists())
                                        <button type="button" class="btn btn-sm btn-rounded text-secondary"
                                            data-bs-toggle="modal" data-bs-target="#unblokirModal"
                                    ...
                                    @else
                                        <button type="button" class="btn btn-sm btn-rounded text-danger"
                                            data-bs-toggle="modal" data-bs-target="#blokirModal"
                                            style="background-color: transparent; margin-top: 10px; border-radius: 10px;box-shadow: 0 0 10px hsla(0, 0%, 60%, 0.25);">
                                    ...
                                    <!-- Modal Blokir -->
                                    <div class="modal fade" id="blokirModal" tabindex="-1"
                                        aria-labelledby="blokirModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-black text-center fs-5 mx-auto mt-0">
                                                    <img src="/assets/img/blokir.png" alt=""
                                    ...
                                    <!-- Modal UnBlokir -->
                                    <div class="modal fade" id="unblokirModal" tabindex="-1"
                                        aria-labelledby="unblokirModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header border-0 text-center w-100 mb-0">
                                                ...
                                                <div class="modal-body text-black text-center fs-5 mx-auto mt-0">
                                                    <img src="/assets/img/unblokir.png" alt=""
                                                        class="d-block mx-auto">
                                    ...
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-sm btn-rounded text-danger"
                                        data-bs-toggle="modal" data-bs-target="#laporkanmodal"
                                        style="background-color: transparent; margin-top: 10px; border-radius: 10px;box-shadow: 0 0 10px hsla(0, 0%, 60%, 0.25);">
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card"
                                                        style="box-shadow: 0px 0px 5px 1px rgba(82, 139, 255, 0.25);">
                                                        <div class="card-body">
                                                            <form id="laporanForm" action="{{ route('laporan.store') }}"
                                                                ...
                                                                <div class="mb-3 d-flex flex-column align-items-start">
                                                                    <label for="bukti"
                                                                        ...
                                                                        Bukti <span
                                                                            class="text-muted fst-italic">(*optional)</span>
                                                                    </label>
                                                                    <img id="preview" src=""
                                                                        alt="Pratinjau Gambar" class="mb-2"
                                                                ...
                                                                <!-- Pilihan Pelanggaran -->
                                                                <div class="mb-3 d-flex flex-column align-items-start">
                                                                    <label class="form-label fw-bold text-start"
                                                                        style="font-size: 15px;">Jenis Pelanggaran</label>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="pelanggaran_privasi" name="pelanggaran"
                                                                            value="Pelanggaran Privasi">
                                                                        <label class="form-check-label"
                                                                            for="pelanggaran_privasi">Pelanggaran
                                                                            Privasi</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="pelanggaran_penipuan" name="pelanggaran"
                                                                            value="Penipuan">
                                                                        <label class="form-check-label"
                                                                            for="pelanggaran_penipuan">Penipuan</label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="pelanggaran_spam" name="pelanggaran"
                                                                            value="Spam">
                                                                        <label class="form-check-label"
                                                                            for="pelanggaran_spam">Spam</label>
                                                                    </div>
                                                                    @error('pelanggaran')
                                                                        <div class="invalid-feedback">{{ $message }}
                                                                        </div>
                                                                ...
                                                                <div class="mb-3 d-flex flex-column align-items-start">
                                                                    <label for="alasan"
                                                                        class="form-label fw-bold text-start"
                                                                        style="font-size: 15px;">
                                                                        Alasan Dilaporkan <span
                                                                            class="text-muted fst-italic">(Maksimal 255
                                                                            karakter)</span>
                                                                    </label>
                                                                    <textarea class="form-control" id="alasan" name="alasan" rows="3" placeholder="Masukkan Alasan Anda"
                                                                        maxlength="255"></textarea>
                                                                    <small id="charCount" class="text-muted">255 karakter
                                                                        tersisa</small>
                                                                    @error('alasan')
                                                            ...
                                                            <script>
                                                                ...
                                                                function submitLaporan() {
                                                                    ...
                                                                    Swal.fire({
                                                                        ...
                                                                        if (result.isConfirmed) {
                                                                            // Mengirim form laporan
                                                                            document.getElementById('laporanForm').submit();
                                                                        }
                                                                    });
                                                                }

                                                                // Menangkap pesan error dari controller dan menampilkan alert sesuai status
                                                                @if (session('error'))
                                                                    Swal.fire({
                                                                        title: "Error!",
                                                                        text: "{{ session('error') }}",
                                                                ...
                                                                // Menangkap pesan sukses dari controller dan menampilkan alert sukses
                                                                @if (session('success'))
                                                                    Swal.fire({
                                                        ...
                                                        <div class="modal-footer d-flex justify-content-between border-0 mx-2"
                                                            ...
                                                            <button type="button" class="btn btn-danger"
                                                                ...
                                                                style="font-size: 14px; padding: 10px 30px;">Laporkan</button>
        ...
        function followUser(userId, userName) {
            fetch(`/follow/${userId}`, {
                ...
                .then(data => {
                    ...
                    icon.className =
                    "fa-solid fa-user-check text-success p-2 rounded-circle"; // Ubah ikon jadi sudah diikuti
                    icon.setAttribute("title", `Sudah mengikuti ${userName}`);
                    icon.setAttribute("onclick",
                    `unfollowUser(${userId}, '${userName}')`); // Ganti fungsi onclick jadi unfollow
        ...
        function unfollowUser(userId, userName) {
            fetch(`/unfollow/${userId}`, {
                ...
                .then(data => {
                    ...
                    icon.setAttribute("onclick",
                    `followUser(${userId}, '${userName}')`); // Ganti fungsi onclick jadi follow
